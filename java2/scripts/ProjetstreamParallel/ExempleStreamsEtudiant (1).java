...
public class ExempleStreamsEtudiant {
    ...
    public static void main(String[] args) {
        ...
        List<Etudiant> etudiants = Arrays.asList(
                ...
                new Etudiant(4, "Mehdi Jabrane", "mehdi.jabrane@etu.ma", 12.5),
                new Etudiant(5, "Salma Najih", "salma.Najih@etu.ma", 14.2),
                new Etudiant(6, "Hamza Farah", "hamza.Farah@etu.ma", 17.8),
...
//
        // 6. MAX/MIN - Meilleur et moins bon étudiant       /*Probleme si deux etudiants ont la meme moyenne*/
